...
<div class="max-w-4xl mx-auto">
    <div class="mb-8 text-center md:text-left">
        <h1 class="text-4xl font-extrabold text-[#0A1A32] tracking-tight mb-2">Input Data Perbaikan</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            <select name="asset_id" id="asset_id" class="w-full rounded-xl border-gray-300 bg-gray-50 py-3.5 pl-5 pr-10 focus:bg-white focus:ring-2 focus:ring-yellow-100 focus:border-yellow-500 transition-all font-medium text-gray-800" required>
